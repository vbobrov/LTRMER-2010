...
port_table.header(["Port","Status","Speed","Duplex","LLDP"])

for port in switch_ports:
    port_table.add_row([port["portId"],port["status"],port["speed"],port["duplex"],port["lldp"]["systemName"] if "lldp" in port else ""])
